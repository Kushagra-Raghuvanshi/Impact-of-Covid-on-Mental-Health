...
def drug_suicide_age() -> Any:
    """Visualise how Age group of respondents relate to reports of substance use and
    suicidal ideation
    """
    orig_dataframe = read_csv_file()
    dataframe = orig_dataframe.loc[6:9, :]

    column1 = 'Started or increased substance use to cope with pandemic-related stress or emotions'
    column2 = 'Seriously considered suicide in past 30 days'
...
def drug_suicide_gender() -> Any:
    """Visualise how the Gender of respondents relate to reports of substance use and
    suicidal ideation
    """
    orig_dataframe = read_csv_file()
...
def drug_suicide_race() -> Any:
    """Visualise how the Race/Ethinic background of respondents relate to reports of substance use
    and suicidal ideation
    """
    orig_dataframe = read_csv_file()
...
def drug_suicide_income() -> Any:
    """Visualise how Income levels of respondents relate to reports of substance use
    and suicidal ideation
    """
    orig_dataframe = read_csv_file()
...
def drug_suicide_education() -> Any:
    """Visualise how Educational status of respondents relate to reports of substance use
    and suicidal ideation
    """
    orig_dataframe = read_csv_file()
